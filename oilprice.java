...
public class oilprice extends JFrame implements ActionListener{
    ...
    oilprice(){
        ...
        String[][] data= {
                {"(주)양지","경기 안양시 만안구 양화로 44 (안양동)","1529원","O"},
                {"대성유류판매(주) 안양지점","경기 안양시 만안구 박달로 552 (안양동)","1529원","X"},
                {"산본","경기 군포시 번영로 607(금정동)","1535원","O"},
                {"구도일안양","경기 안양시 만안구 만안로 135","1535원","O"},
                {"서일","경기 안양시 만안구 박달로 569","1535원","O"},
                {"안양알찬","경기 안양시 동안구 시민대로 301","1535원","O"},
                {"금정","경기 군포시 공단로 278-29","1537원","X"},
                {"시몬","경기 안양시 동안구 부림로 194","1538원","O"},
                {"청기와","경기 안양시 만안구 만안로 114","1538원","O"},
                {"군포제일","경기 군포시 산본로 323번길 27","1539원","X"}
                };
